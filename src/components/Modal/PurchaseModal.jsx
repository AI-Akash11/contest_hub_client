      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div className="flex min-h-full items-center justify-center p-4">
          ...
          >
            ...
            <div className="mt-2">
              <p className="text-sm text-base-content/60">Plant: Money Plant</p>
            </div>
            <div className="mt-2">
              <p className="text-sm text-base-content/60">Category: Indoor</p>
            </div>
            <div className="mt-2">
              <p className="text-sm text-base-content/60">Customer: PH</p>
            </div>

            <div className="mt-2">
              <p className="text-sm text-base-content/60">Price: $ 120</p>
            </div>
            <div className="mt-2">
