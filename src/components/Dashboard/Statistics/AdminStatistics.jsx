    ...
    <div>
      <div className="mt-12">
        ...
        <div className="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 grow">
          {/* Sales Card */}
          <div className="relative flex flex-col bg-clip-border rounded-xl bg-secondary text-base-content/80 shadow-md">
            <div
          ...
          {/* Total Orders */}
          <div className="relative flex flex-col bg-clip-border rounded-xl bg-accent text-base-content/80 shadow-md">
            <div
          ...
          {/* Total Plants */}
          <div className="relative flex flex-col bg-clip-border rounded-xl bg-primary text-base-content/80 shadow-md">
            <div
          ...
          {/* Users Card */}
          <div className="relative flex flex-col bg-clip-border rounded-xl bg-error text-base-content/80 shadow-md">
            <div
        ...
        <div className="mb-4 grid grid-cols-1 gap-6 lg:grid-cols-2 xl:grid-cols-3">
          {/*Sales Bar Chart */}
          <div className="relative flex flex-col bg-clip-border rounded-xl bg-base-100 text-base-content/80 shadow-md overflow-hidden xl:col-span-2">
            {/* Chart goes here.. */}
          </div>
          {/* Calender */}
          <div className=" relative flex flex-col bg-clip-border rounded-xl bg-base-100 text-base-content/80 shadow-md overflow-hidden">
            {/* Calender */}
          </div>
        </div>
      </div>
