  ...
  return (
    <>
      ...
      <div className="bg-base-200 text-base-content flex justify-between md:hidden">
        <div>
          <div className="block cursor-pointer p-4 font-bold gradient-text">
            <Link to="/">Contest Hub</Link>
          </div>
        </div>
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div>
            ...
            <button
              onClick={logOut}
              className="flex cursor-pointer w-full items-center px-4 py-2 mt-5 text-base-content/60 hover:bg-base-300   hover:text-base-content/70 transition-colors duration-300 transform"
            >
