      ...
      <section className="my-5 md:my-10 lg:my-20">
          ...
          >
            ...
            <p className="text-base-content/70 max-w-2xl mx-auto">
              Celebrate our talented winners who showcased exceptional
              creativity and skills. You could be next!
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-base-300 p-6 md:p-8 rounded-2xl mb-12"
          >
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="mt-12 p-8 md:p-12 rounded-2xl bg-linear-to-r from-primary/20 via-secondary/20 to-accent/20 text-center"
          >
