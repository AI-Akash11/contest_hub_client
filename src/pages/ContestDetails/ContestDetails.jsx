      ...
      <div className="bg-gradient-to-r from-success/20 to-success/10 rounded-lg p-4 border border-success/30">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-xs text-base-content/60">Prize Money</p>
              <p className="text-2xl font-bold text-success">${prizeMoney}</p>
            </div>
          </div>
...
const PendingWinnerCard = () => (
  <div className="p-6 md:p-8 bg-gradient-to-br from-warning/5 to-warning/10 border border-warning/30 rounded-2xl text-center">
...
const OngoingContestCard = () => (
  <div className="p-6 md:p-8 bg-gradient-to-br from-accent/5 to-accent/10 border border-accent/30 rounded-2xl text-center">
    <div className="flex justify-center mb-4">
